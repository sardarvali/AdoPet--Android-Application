...
import com.syed.adapters.UserAdoptionRequestsAdapter
...
class MyAdoptionRequestsFragment : Fragment() {
    ...
    private lateinit var requestsAdapter: UserAdoptionRequestsAdapter
    ...
    private fun setupRecyclerView() {
        requestsAdapter =
            UserAdoptionRequestsAdapter(requireContext()) { request ->
            ...
            .addOnSuccessListener { documents ->
                val requests =
                    documents.mapNotNull { doc ->
                        doc.toObject(AdoptionRequest::class.java).copy(id = doc.id)
                    }
